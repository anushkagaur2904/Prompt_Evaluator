    ...
    <div className="glass rounded-[var(--radius)] p-6 border border-slate-700 shadow-2xl mt-8">
      ...
      <div className="flex items-center justify-between mb-6 gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-400">
            Track versions and store prompt history for regression analysis.
          </p>
        </div>
      ...
      {promptHistory.length === 0 ? (
        ...
        <div className="text-zinc-400">
          No prompt history found for the current prompt.
        </div>
        ...
        <div className="space-y-3">
          ...
          {promptHistory.map((entry, index) => (
            ...
            <div
              key={entry.id || index}
              className="bg-zinc-950/70 border border-zinc-800 rounded-3xl p-4"
            >
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-full bg-red-500/80 px-3 py-1 text-xs font-semibold text-white hover:bg-red-500 transition"
                  >
                    Delete
                  </button>
